...
- 以同样的方式安装claude code拓展，然后claude不需额外配置，因为已经配置在本地了![屏幕截图 2026-06-24 215747 1](attachment/屏幕截图%202026-06-24%20215747.png)
...
### 运用
- 打开一个你需要工作的文件夹
- 新建文件，选择jupyter notebook,新建了一个.ipynb文件![屏幕截图 2026-06-24 215855 1](attachment/屏幕截图%202026-06-24%20215855.png)
